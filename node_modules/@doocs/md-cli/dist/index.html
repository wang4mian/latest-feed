...
<html lang="zh-CN">
  <head>
    <script src="https://www.googletagmanager.com/gtag/js?id=G-7NZL3PZ0NK" async></script>
    <script>window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-7NZL3PZ0NK');
</script>
    ...
    <script type="module" crossorigin src="/md/static/js/md-index-4K8vrVBp.js"></script>
    <link rel="stylesheet" crossorigin href="/md/static/css/md-index-CwlSfNZa.css">
  </head>
