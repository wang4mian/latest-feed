...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_BhVt_vC-.mjs'
    ).then(n => n.Z).catch((e) => {
...
}, "/Users/simianwang/Desktop/latest-feed/node_modules/astro/components/Image.astro", void 0);
...
}, "/Users/simianwang/Desktop/latest-feed/node_modules/astro/components/Picture.astro", void 0);
